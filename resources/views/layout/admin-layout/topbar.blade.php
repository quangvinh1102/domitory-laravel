<div class="navbar-custom">
    <ul class="list-unstyled topbar-menu float-end mb-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 text-truncate ms-2">
                                    <h5 class="noti-item-title fw-semibold font-14">Lương Văn Hòa <small
                                            class="fw-normal text-muted ms-1">1 phút trước</small></h5>
                    ...
                    <a href="javascript:void(0);" class="dropdown-item p-0 notify-item card read-noti shadow-none mb-2">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 text-truncate ms-2">
                                    <h5 class="noti-item-title fw-semibold font-14">Lã Thế Anh <small
                                            class="fw-normal text-muted ms-1">1 giờ trước</small></h5>
                    ...
                    <a href="javascript:void(0);" class="dropdown-item p-0 notify-item card read-noti shadow-none mb-2">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 text-truncate ms-2">
                                    <h5 class="noti-item-title fw-semibold font-14">Mèo méo meo <small
                                            class="fw-normal text-muted ms-1">1 ngày trước</small></h5>
        ...
        <li class="dropdown notification-list" style="line-height: 70px;">
            ...
            <input hidden class="form-check-input" type="checkbox" name="color-scheme-mode" value="light"
                id="light-mode-check">
            <label class="form-check-label light-btn  d-none" for="light-mode-check"><i style="font-size: 25px;"
                    class="mdi mdi-weather-night"></i></label>
            <input hidden class="form-check-input" type="checkbox" name="color-scheme-mode" value="dark"
                id="dark-mode-check">
            <label class="form-check-label dark-btn" for="dark-mode-check"><i style="font-size: 25px;"
                    class="mdi mdi-weather-sunny"></i></label>
        </li>
